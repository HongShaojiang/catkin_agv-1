...
"""autogenerated by genpy from dgvmsg/Twist.msg. Do not edit."""
import sys
...
float64 z"""
  ...
  _slot_types = ['dgvmsg/Vector3','dgvmsg/Vector3']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.linear is None:
        self.linear = dgvmsg.msg.Vector3()
      if self.angular is None:
        self.angular = dgvmsg.msg.Vector3()
    else:
      self.linear = dgvmsg.msg.Vector3()
      self.angular = dgvmsg.msg.Vector3()
